        ...
        <div class="file-list">
          <!-- <section class="file-item draggable-item" v-for="(item,index) in files" :key="index"> -->
            <div class="thumbnails my-gallery">
                ...
                <section class="thumbnail" v-if="this.files.length < 1">
                  <div class="add">
                    <span :class="{card2: cardType == 2}"></span>
...
.add {
  ...
  span{
    ...
    width: 100%;
    height: 3.5rem;
    background: url(../assets/images/idcard1.png) center no-repeat;
    background-size: contain;
  }
  .card2{
    background-image: url(../assets/images/idcard2.png);
  }
}
.uploadBtn {
  position: relative;
