<template>
  <div class="order-wrap">
    <section class="order-con">
      ...
      <div class="order-top">{{statusDesc[status]}}</div>
      ...
      <div class="order-list">
        ...
        <div style="padding-left: .7rem">收货人：{{orderData.deliveryName}}</div>
      </div>
      <div class="fr">
        <mt-button v-if="status == 1" @click="completeOrder" type="primary" size="small">完成</mt-button>
